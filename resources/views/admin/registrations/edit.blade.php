    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <input
                type="date"
                name="birth_date"
                value="{{ old('birth_date', $registration->birth_date) }}"
                class="form-input"
            >
        ...
        <div class="form-group">
            ...
            >{{ old('address', $registration->address) }}</textarea>
        ...
        <div class="form-group">
            ...
            <input
                type="text"
                name="instagram"
                value="{{ old('instagram', $registration->instagram) }}"
                class="form-input"
            >
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            >
                ...
                @foreach($vehicleModels as $model)
                    ...
                    <option
                        value="{{ $model }}"
                        {{ old('vehicle_model', $registration->vehicle_model) == $model ? 'selected' : '' }}
                    >
                        {{ $model }}
                    </option>
        ...
        <div class="form-group">
            ...
            <input
                type="number"
                name="vehicle_year"
                value="{{ old('vehicle_year', $registration->vehicle_year) }}"
                class="form-input"
            >
        ...
        <div class="form-group">
            ...
            <input
                type="text"
                name="vehicle_color"
                value="{{ old('vehicle_color', $registration->vehicle_color) }}"
                class="form-input"
            >
        ...
        <div class="form-group">
            ...
            <input
                type="text"
                name="license_plate"
                value="{{ old('license_plate', $registration->license_plate) }}"
                class="form-input"
            >
