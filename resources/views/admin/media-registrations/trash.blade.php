...
@section('content')
        ...
        ">
                ...
                ">
                        ...
                        ">
                                        ...
                                        <form action="/admin/media-registrations-trash/{{ $registration->id }}/restore"
                                            method="POST">
                                ...
                                ">
                                        ...
                                        <form action="/admin/media-registrations-trash/{{ $registration->id }}/force-delete"
                                            method="POST">
    ...
    ">
            ...
            <p>
                Belum ada data media yang dihapus.
            </p>
